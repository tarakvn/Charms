...
class _HomePageState extends State<HomePage> {
  ...
  void _castSpell(String text) async {
    // تبدیل متن شنیده شده به حروف کوچک برای مقایسه دقیق
    final String normalizedText = text.toLowerCase().trim();

    for (var spell in allSpells) {
      // تبدیل طلسم ذخیره شده در فایل به حروف کوچک برای مقایسه
    ...
    // نمایش متن شنیده شده با حرف اول بزرگ
    setState(() => _status = 'ناشناخته: "${_capitalize(normalizedText)}"');
  }
